...
class Sale(db.Model):
    ...
    inventory_item_id = db.Column(db.Integer, nullable=True)  # Collegamento al prodotto venduto
    quantity_sold = db.Column(db.Integer, default=1)  # Quantità venduta
    created_at = db.Column(db.DateTime, default=datetime.utcnow)
...
class Inventory(db.Model):
    ...
    brand = db.Column(db.String(50))  # Wind, Vodafone, Fastweb, No Brand
    device_brand = db.Column(db.String(100))  # Samsung, Apple, Huawei, etc.
    model = db.Column(db.String(100))
    color = db.Column(db.String(50))
    ram = db.Column(db.String(20))  # 4GB, 8GB, etc.
    storage = db.Column(db.String(20))  # 64GB, 128GB, etc.
    quantity = db.Column(db.Integer, nullable=False, default=0)
    price = db.Column(db.Float, nullable=False)
    category = db.Column(db.String(100))  # Smartphone, Accessori, SIM, etc.
    notes = db.Column(db.Text)
    created_at = db.Column(db.DateTime, default=datetime.utcnow)
    ...
    def is_low_stock(self):
        """Verifica se il prodotto ha scorte basse (meno di 5)"""
